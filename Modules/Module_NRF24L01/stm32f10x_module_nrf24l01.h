#ifndef __STM32F10X_MODULE_NRF24L01_H
#define __STM32F10X_MODULE_NRF24L01_H
...
#define NRF24L01_CSN_H	GPIO_SetBits(GPIOA, GPIO_Pin_4) 			// SPI片选信号
#define NRF24L01_CSN_L	GPIO_ResetBits(GPIOA, GPIO_Pin_4)
#define NRF24L01_IRQ 	GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_15)	// IRQ主机数据输入
...
extern void NRF_Matching(void); //NRF24L01对频接收地址
